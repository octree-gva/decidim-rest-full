...
## Shell provisioning (optional)

For servers, CI, or automation, the gem ships an `api-client` binstub (create, get, grant, revoke). That reference lives with the other **developer** docs: [API client CLI](/dev/api-client-cli).
