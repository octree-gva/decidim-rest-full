...
2. **Import OpenAPI** as a collection — use the published file [`/openapi.json`](https://octree-gva.github.io/decidim-rest-full/openapi.json) on the docs site, or generate locally with `yarn gen:openapi-spec` (writes `website/static/openapi.json`).
