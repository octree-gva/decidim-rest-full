...
Gem::Specification.new do |s|
  s.name = "decidim-restfull-meetings"
  ...
  s.summary = "Decidim RestFull API — meetings (+ upcoming reminder webhooks)"
  ...
  s.add_dependency "decidim-meetings", Decidim::RestFull.decidim_version
