  ...
  module Api
    module RestFull
      module Proposals
        ...
        class ProposalSerializer < ::Decidim::Api::RestFull::Core::ResourceSerializer
          ...
          has_one :author,
                  ...
                  serializer: ::Decidim::Api::RestFull::Core::UserSerializer do |proposal, _params|
            proposal.coauthorships.first.author
          end

          has_many :coauthors,
                   meta: (proc do |proposal, _params|
