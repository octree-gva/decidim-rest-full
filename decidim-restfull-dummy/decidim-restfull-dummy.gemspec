...
Gem::Specification.new do |s|
  ...
  s.summary = "Decidim RestFull API — dummy Extension example (dev/test only)"
  s.description = "Stub feature gem that registers via Extension + Toggle; controllers raise 501."
