...
Gem::Specification.new do |s|
  s.name = "decidim-restfull-accountabilities"
  ...
  s.summary = "Decidim RestFull API — accountability results"
  ...
  s.add_dependency "decidim-accountability", Decidim::RestFull.decidim_version
