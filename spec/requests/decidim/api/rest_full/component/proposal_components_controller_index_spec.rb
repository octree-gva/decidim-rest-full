...
RSpec.describe Decidim::Api::RestFull::Component::ProposalComponentsController, type: :request do
  path "/public/components/proposals" do
    get "List Proposal Components" do
      tags "Components"
      ...
      response "500", "Internal Server Error" do
        ...
        before do
          controller = Decidim::Api::RestFull::Component::ProposalComponentsController.new
          allow(controller).to receive(:index).and_raise(StandardError.new("Intentional error for testing"))
          allow(Decidim::Api::RestFull::Component::ProposalComponentsController).to receive(:new).and_return(controller)
        end
