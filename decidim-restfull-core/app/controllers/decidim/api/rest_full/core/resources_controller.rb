  ...
  module Api
    module RestFull
      module Core
        ...
        # default_order_column. Scopes by component/space using +filter_for_context+ and
        # +in_visible_spaces+ on ApplicationController (see Decidim::RestFull::ParticipatorySpaceVisibility).
        #
        ...
        class ResourcesController < Decidim::Api::RestFull::ApplicationController
          ...
          include Decidim::Api::RestFull::CollectionPaginationMeta

          protected

          # Default conditional GET for +show+ when the subclass sets +@resource+ before rendering.
          def conditional_get_fingerprint
            return unless defined?(@resource) && @resource

            Decidim::RestFull::Core::HttpCache::ResourceShowFingerprint.for_request(self, @resource)
          end
