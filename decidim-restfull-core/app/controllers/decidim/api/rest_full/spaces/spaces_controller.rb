    ...
    module RestFull
      module Spaces
        class SpacesController < ApplicationController
          ...
          def show
            record = space_show_query
            payload = Core::SpaceSerializer.new(record, params: space_serializer_params).serializable_hash
            render_json_with_conditional_get(payload, fingerprint: resource_fingerprint_for(record))
          end
