...
Decidim::RestFull::Core::DefinitionRegistry.register_object(:organization_attributes) do
  {
    ...
    properties: {
      ...
      reference_prefix: { type: :string, description: "Prefix for the organization. Used to prefix uploaded files and reference resources" },
      host: { type: :string },
      ...
      default_locale: { type: :string, description: "Default locale for the organization" },
