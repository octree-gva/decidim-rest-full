...
RSpec.describe Decidim::RestFull::Core::WebhookRegistration do
  ...
  describe "#send_webhook" do
    ...
    context "when handling errors" do
      it "raises a WebhookFailedError error when the response is not 200" do
        ...
        expect { webhook_registration.send_webhook(event, timestamp) }.to raise_error(Decidim::RestFull::WebhookFailedError)
      end
